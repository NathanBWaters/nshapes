...
* **Rounds 1–2:** 2 Attributes (Shape, Color)
* **Rounds 3–4:** 3 Attributes (adds Number)
* **Rounds 5–9:** 4 Attributes (adds Shading)
...
4. **Progression:** After Round 2, 4, and 9, the game introduces the next attribute dimension.
