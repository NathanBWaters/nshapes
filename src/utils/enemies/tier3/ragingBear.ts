 ...
 *
 * Effects: Stalking Wolf (30s → INSTANT DEATH) + Stinging Scorpion (2x) + Circling Vulture (4pts/sec)
  ...
  return composeEffects(
    {
      ...
      tier: 3,
      description: '30s inactivity → instant death, 2x damage/points, score drains 4pts/sec',
    ...
    [
      ...
      { behavior: ScoreDecayEffect, config: { ratePerSecond: 4 } },
    ],
    // Defeat condition: 7-match streak with no invalid matches
