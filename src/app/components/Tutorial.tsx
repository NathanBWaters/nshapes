    ...
    <div className="mt-4">
      ...
      {isOpen && (
        <div className="mt-4 p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
          <h2 className="text-2xl font-bold mb-4">How to Play Set</h2>
          ...
          <h3 className="text-xl font-semibold mb-2">What Makes a Set?</h3>
          <p className="mb-2">
            A <strong>Set</strong> consists of three cards where each attribute is either all the same OR all different.
          </p>
          <p className="mb-4">
            For example, if two cards have the same shape and the third has a different shape, that&apos;s not a Set.
            All three shapes must be the same, or all three must be different.
          </p>
          
          <h3 className="text-xl font-semibold mb-2">Examples of Valid Sets</h3>
          <ul className="list-disc pl-6 mb-4">
          ...
          <ol className="list-decimal pl-6 mb-4">
            <li>Click on three cards you believe form a Set</li>
            <li>If correct, the cards will be removed and replaced</li>
            <li>If no Sets exist in the visible cards, use &quot;Add Cards&quot; to add more</li>
            <li>If you&apos;re stuck, use a &quot;Hint&quot; to highlight a valid Set</li>
          </ol>
          
          <h3 className="text-xl font-semibold mb-2">Scoring</h3>
          <p className="mb-4">
            +1 point for each Set found. The game ends when no more Sets can be found or the deck is exhausted.
          </p>
